            ...
            <c:when test="${report != null}">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            <th>いいね！数</th>
                            <td class="report_goods"><c:out value="${goods_count}" />
                            </td>
                        <tr>
                            <th>登録日時</th>
                ...
                <c:choose>
                    <c:when test="${good != null}">
                        <form method="POST" action="<c:url value="/goods/destroy" />">
                            ...
                            <input type="hidden" name="unReport_id" value="${report.id}">
                            <button class="ungoodbutton" type="submit">いいね済み！</button>
                        </form>
                    </c:when>
                    <c:otherwise>
                        <form method="POST" action="<c:url value='/goods/create' />">
                            ...
                            <button class="goodbutton" id="square-button" type="submit">いいね！</button>
                        </form>
                    </c:otherwise>
                </c:choose>
                     ...
                     <c:choose>
                        <c:when test="${follow != null}">
                            <form method="POST" action="<c:url value="/follows/destroy" />">
                                <input type="hidden" name="_token" value="${_token}" />
                                <input type="hidden" name="unfollow_id" value="${report.id}" />
                        ...
                        <c:otherwise>
                            <form method="POST" action="<c:url value="/follows/create" />">
                                <input type="hidden" name="_token" value="${_token}" />
                                <input type="hidden" name="follow_id" value="${report.id}" />
