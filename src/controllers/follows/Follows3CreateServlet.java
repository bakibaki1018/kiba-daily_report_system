...
/**
 * Servlet implementation class Follows3CreateServlet
 */
@WebServlet("/follows3/create")
public class Follows3CreateServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Follows3CreateServlet() {
        super();
