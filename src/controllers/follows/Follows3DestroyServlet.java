...
/**
 * Servlet implementation class Follows3DestroyServlet
 */
@WebServlet("/follows3/destroy")
public class Follows3DestroyServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Follows3DestroyServlet() {
        super();
